...
#PBS -N data1_taxonomic_kaiju_analysis_nr_euk
#PBS -q normal
#PBS -P CBBI1470
...
INPUT_CONCAT=/mnt/lustre/users/maloo/euMwanza/data1_filtering_results/S1_S1_L001_concat.fastq
#INPUT_FASTQ_R1=/mnt/lustre/users/maloo/euMwanza/data1_filtering_results/S1_S1_L001_R1_001.filt.fastq.gz
# INPUT_FASTQ_R2=/mnt/lustre/users/maloo/euMwanza/data1_filtering_results/S1_S1_L001_R2_001.filt.fastq.gz 
...
# -f $FUNGI_KAIJU_INDEX \
# -i $INPUT_CONCAT \
# -o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_FUNGI_DB.out
...
-f $NR_EUK_INDEX \
-i $INPUT_CONCAT \
-o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_NR_EUK_DB.out
...
# -f $PLASMIDS_INDEX \
# -i $INPUT_CONCAT \
# -o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_PLASMIDS_DB.out
...
# -f $REFSEQ_INDEX \
# -i $INPUT_CONCAT \
# -o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_REFSEQ_DB.out
...
# -f $REFSEQ_NR_INDEX \
# -i $INPUT_CONCAT \
# -o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_REFSEQ_NR_DB.out
...
# -f $REFSEQ_REF_INDEX \
# -i $INPUT_CONCAT \
# -o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_REFSEQ_REF_DB.out
...
# -f $RVDB_INDEX \
# -i $INPUT_CONCAT \
# -o $OUTPUT_FILE/data1_kaiju/data1_kaiju_analysis_RVDB.out
