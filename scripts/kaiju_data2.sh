...
#PBS -N data2_taxonomic_kaiju_analysis_nr_euk
#PBS -q normal
#PBS -P CBBI1470
...
INPUT_FASTQ_R1=/mnt/lustre/users/maloo/euMwanza/data2_filtering_results/S2_S1_L001_R1_001.filt.fastq.gz
INPUT_FASTQ_R2=/mnt/lustre/users/maloo/euMwanza/data2_filtering_results/S2_S1_L001_R2_001.filt.fastq.gz
...
# -i $INPUT_FASTQ_R1 \
# -j $INPUT_FASTQ_R2 \
# -o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_FUNGI_DB.out
...
-i $INPUT_FASTQ_R1 \
-j $INPUT_FASTQ_R2 \
-o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_NR_EUK_DB.out
...
# -i $INPUT_FASTQ_R1 \
# -j $INPUT_FASTQ_R2 \
# -o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_PLASMIDS_DB.out
...
# -i $INPUT_FASTQ_R1 \
# -j $INPUT_FASTQ_R2 \
# -o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_REFSEQ_DB.out
...
# -i $INPUT_FASTQ_R1 \
# -j $INPUT_FASTQ_R2 \
# -o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_REFSEQ_NR_DB.out
...
# -i $INPUT_FASTQ_R1 \
# -j $INPUT_FASTQ_R2 \
# -o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_REFSEQ_REF_DB.out
...
# -i $INPUT_FASTQ_R1 \
# -j $INPUT_FASTQ_R2 \
# -o $OUTPUT_FILE/data2_kaiju/data2_kaiju_analysis_RVDB.out
